                        ...
                        <div class="col-sm-8 col-8">
                          ...
                          <div class="sc-action-links">
                            <select @change="onChangeQuantity($event, product)">
                              <option v-for="i in 10" :key="i" :value="i" :selected="checkQuantity(product.quantity, i)">Qty: &nbsp;{{ i }}</option>
                            </select>
                            &nbsp;&nbsp;
                            <span>|</span>
                            &nbsp;
                  ...
                  <div>
                    <span class="a-spacing-small a-button-primary a-button-icon">
                      <span class="a-button-inner">
                          <nuxt-link to="/address" class="a-button-text">Add address</nuxt-link>
                      </span>
                    </span>
                    <span class="a-spacing-small a-button-primary a-button-icon">
                      <span class="a-button-inner">
                          <nuxt-link to="/placeorder" class="a-button-text">Placeorder</nuxt-link>
                      </span>
                    </span>
                  </div>
                </div>
