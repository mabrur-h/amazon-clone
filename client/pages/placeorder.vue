                    ...
                    <div class="a-row">
                      <div class="displayAddressDiv">
                        ...
                        <ul class="displayAddressUL">
                          ...
                          <li>{{ address.address.streetAddress }}</li>
                          <li>{{ address.address.city }}</li>
                          <li>{{ address.address.country }}</li>
                          <li>{{ address.address.zipCode }}</li>
                          <li>
                            Phone:
                            <span dir="ltr">{{ address.address.phoneNumber }}</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="a-row a-spacing-base" v-for="product in getCart" :key="product._id">
                      <div class="row">
                        ...
                        <div class="col-sm-9 col-9">
                          ...
                          <div class="a-row a-size-small">by {{ product.ownerID.name }}</div>
                          <div class="a-row">
                            <!-- Product's price -->
